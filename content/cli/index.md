            ...
            <div class="tab-content" id="myTabContent">
              ...
              >
                <ul class="list-group">
                  <li class="list-group-item">
                    <a
                      href="https://github.com/Pinggy-io/cli-js/releases/download/v0.3.5/pinggy-win-x64.exe"
                      target="_blank"
                  ...
                  <li class="list-group-item">
                    <a
                      href="https://github.com/Pinggy-io/cli-js/releases/download/v0.3.5/pinggy-win-arm64.exe"
                      target="_blank"
                      class="btn btn-primary"
                      style="background-color: rgba(70, 117, 199, 1)"
              ...
              >
                <ul class="list-group">
                  <li class="list-group-item">
                    <a
                      href="https://github.com/Pinggy-io/cli-js/releases/download/v0.3.5/pinggy-macos-arm64"
                      target="_blank"
                      class="btn btn-primary"
                      style="background-color: rgba(70, 117, 199, 1)"
                  ...
                  <li class="list-group-item">
                    <a
                      href="https://github.com/Pinggy-io/cli-js/releases/download/v0.3.5/pinggy-macos-x64"
                      target="_blank"
                      class="btn btn-primary"
                      style="background-color: rgba(70, 117, 199, 1)"
              ...
              >
                <ul class="list-group">
                  <li class="list-group-item">
                    <a
                      href="https://github.com/Pinggy-io/cli-js/releases/download/v0.3.5/pinggy-linux-x64"
                      target="_blank"
                      class="btn btn-primary"
                      style="background-color: rgba(70, 117, 199, 1)"
                  ...
                  <li class="list-group-item">
                    <a
                      href="https://github.com/Pinggy-io/cli-js/releases/download/v0.3.5/pinggy-linux-arm64"
                      target="_blank"
                      class="btn btn-primary"
                      style="background-color: rgba(70, 117, 199, 1)"
