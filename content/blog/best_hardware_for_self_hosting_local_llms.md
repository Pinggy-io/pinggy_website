...
draft: false
tags: ["local LLM", "self-hosted AI", "Apple Silicon", "Ollama", "AI hardware"]
...
For what to actually run on this hardware, see the {{< link href="/blog/best_open_source_self_hosted_llms_for_coding/" >}}best open source LLMs for coding{{< /link >}} guide and {{< link href="/blog/top_5_local_llm_tools_and_models/" >}}top local LLM tools{{< /link >}} for inference software comparisons.
