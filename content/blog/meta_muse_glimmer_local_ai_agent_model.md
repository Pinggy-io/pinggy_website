...
Weights are on Hugging Face under Apache 2.0, which is about as unrestricted as an open-weight license gets: no usage tier gates, no field-of-use carve-outs, commercial use included.
