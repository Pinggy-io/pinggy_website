...
Both paths skip the parts of a normal messaging app that require a company behind them: no phone number verification, no account database, no push notification service tied to your identity, no central server logging who messaged whom. The iOS client is released into the public domain; the <a href="https://github.com/permissionlesstech/bitchat-android" target="_blank">Android client</a> is MIT-licensed. The project's <a href="https://github.com/permissionlesstech/bitchat/blob/main/WHITEPAPER.md" target="_blank">whitepaper</a> is refreshingly direct about what that buys you and what it doesn't, which is worth reading before assuming "decentralized" means "unbreakable."
