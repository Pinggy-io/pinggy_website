...
draft: false
tags: ["LLM benchmarks", "generative AI"]
...
{{< image "why_llm_benchmarks_need_a_reset/evaluation_flowchart_page4_fig1.webp" "Evaluation Flowchart for LLM Benchmarks (Fig. 1)" >}}
...
<tr>
  ...
  <th style="border:1px solid #ddd;padding:0.5em;text-align:left;background:#f5f7fa;color:#333;font-weight:bold;">Recurring inadequacies across benchmark studies</th>
...
{{< image "why_llm_benchmarks_need_a_reset/prevalence_of_llm_benchmark_inadequacies_page7_table2.webp" "Prevalence of LLM Benchmark Inadequacies (Table II)" >}}
