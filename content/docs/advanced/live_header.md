...
{{< ssh_command >}}
"{\"cli\":{\"windows\":{\"ps\":\"./pinggy.exe -p 443 -R0:localhost:8000 -t free.pinggy.io a:X-Pinggy-Forwarded:true\",\"cmd\":\"./pinggy.exe -p 443 -R0:localhost:8000 -t free.pinggy.io a:X-Pinggy-Forwarded:true\"},\"linux\":{\"ps\":\"./pinggy -p 443 -R0:localhost:8000 -t free.pinggy.io a:X-Pinggy-Forwarded:true\",\"cmd\":\"./pinggy -p 443 -R0:localhost:8000 -t free.pinggy.io a:X-Pinggy-Forwarded:true\"}},\"ssh\":{\"windows\":{\"ps\":\"ssh -p 443 -R0:localhost:8000 -t free.pinggy.io a:X-Pinggy-Forwarded:true\",\"cmd\":\"ssh -p 443 -R0:localhost:8000 -t free.pinggy.io a:X-Pinggy-Forwarded:true\"},\"linux\":{\"ps\":\"ssh -p 443 -R0:localhost:8000 -t free.pinggy.io a:X-Pinggy-Forwarded:true\",\"cmd\":\"ssh -p 443 -R0:localhost:8000 -t free.pinggy.io a:X-Pinggy-Forwarded:true\"}}}"
{{</ ssh_command >}}
...
- How to add more manipulation? Just add at the end. For example, if we want to remove `Referer` header along with changing the `Host`, we need following command
  ...
  {{< ssh_command >}}
  "{\"cli\":{\"windows\":{\"ps\":\"./pinggy.exe -p 443 -R0:localhost:8080 -t free.pinggy.io u:Host:example.com r:Referer\",\"cmd\":\"./pinggy.exe -p 443 -R0:localhost:8080 -t free.pinggy.io u:Host:example.com r:Referer\"},\"linux\":{\"ps\":\"./pinggy -p 443 -R0:localhost:8080 -t free.pinggy.io u:Host:example.com r:Referer\",\"cmd\":\"./pinggy -p 443 -R0:localhost:8080 -t free.pinggy.io u:Host:example.com r:Referer\"}},\"ssh\":{\"windows\":{\"ps\":\"ssh -p 443 -R0:localhost:8080 -t free.pinggy.io u:Host:example.com r:Referer\",\"cmd\":\"ssh -p 443 -R0:localhost:8080 -t free.pinggy.io u:Host:example.com r:Referer\"},\"linux\":{\"ps\":\"ssh -p 443 -R0:localhost:8080 -t free.pinggy.io u:Host:example.com r:Referer\",\"cmd\":\"ssh -p 443 -R0:localhost:8080 -t free.pinggy.io u:Host:example.com r:Referer\"}}}"
  {{</ ssh_command >}}
